...
*/
    ...
    "go to my contests from lobby. B" taggedAs(WIP, BigResolution) in {
      implicit val resolution:Resolution = Resolution.BIG
      callTest(goToMyContestsFromLobby)
    }
    "go to my contests from lobby. M" taggedAs(WIP, MediumResolution) in {
      implicit val resolution:Resolution = Resolution.MEDIUM
      callTest(goToMyContestsFromLobby)
    }
    "go to my contests from lobby. S" taggedAs(WIP, SmallResolution) in {
      implicit val resolution:Resolution = Resolution.SMALL
      callTest(goToMyContestsFromLobby)
    }
...
*/
    "go to game promos from lobby. B" taggedAs(WIP, BigResolution) in {
      implicit val resolution:Resolution = Resolution.BIG
      callTest(goToGamePromosFromLobby)
    }
    "go to game promos from lobby. M" taggedAs(WIP, MediumResolution) in {
      implicit val resolution:Resolution = Resolution.MEDIUM
      callTest(goToGamePromosFromLobby)
    }
    "go to game promos from lobby. S" taggedAs(WIP, SmallResolution) in {
      implicit val resolution:Resolution = Resolution.SMALL
      callTest(goToGamePromosFromLobby)
    }
...
*/
    "go to game promos from my contests. B" taggedAs(WIP, BigResolution) in {
      implicit val resolution:Resolution = Resolution.BIG
      callTest(goToGamePromosFromMyContests)
    }
    "go to game promos from my contests. M" taggedAs(WIP, MediumResolution) in {
      implicit val resolution:Resolution = Resolution.MEDIUM
      callTest(goToGamePromosFromMyContests)
    }
    "go to game promos from my contests. S" taggedAs(WIP, SmallResolution) in {
      implicit val resolution:Resolution = Resolution.SMALL
      callTest(goToGamePromosFromMyContests)
    }
/*
...
*/
    "go to lobby from my contests. B" taggedAs(WIP, BigResolution) in {
      implicit val resolution:Resolution = Resolution.BIG
      callTest(goToLobbyFromMyContests)
    }
    "go to lobby from my contests. M" taggedAs(WIP, MediumResolution) in {
      implicit val resolution:Resolution = Resolution.MEDIUM
      callTest(goToLobbyFromMyContests)
    }
    "go to lobby from my contests. S" taggedAs(WIP, SmallResolution) in {
      implicit val resolution:Resolution = Resolution.SMALL
      callTest(goToLobbyFromMyContests)
    }
...
*/
    "go to lobby from game promos. B" taggedAs(WIP, BigResolution) in {
      implicit val resolution:Resolution = Resolution.BIG
      callTest(goToLobbyFromGamePromos)
    }
    "go to lobby from game promos. M" taggedAs(WIP, MediumResolution) in {
      implicit val resolution:Resolution = Resolution.MEDIUM
      callTest(goToLobbyFromGamePromos)
    }
    "go to lobby from game promos. S" taggedAs(WIP, SmallResolution) in {
      implicit val resolution:Resolution = Resolution.SMALL
      callTest(goToLobbyFromGamePromos)
    }
/*
...
*/
    "go to my contests from game promos. B" taggedAs(WIP, BigResolution) in {
      implicit val resolution:Resolution = Resolution.BIG
      callTest(goToLobbyFromGamePromos)
    }
    "go to my contests from game promos. M" taggedAs(WIP, MediumResolution) in {
      implicit val resolution:Resolution = Resolution.MEDIUM
      callTest(goToLobbyFromGamePromos)
    }
    "go to my contests from game promos. S" taggedAs(WIP, SmallResolution) in {
      implicit val resolution:Resolution = Resolution.SMALL
      callTest(goToLobbyFromGamePromos)
    }
